...
<html lang="es">
  <head>
    ...
    />
    <title>
      Industries - Industrial Category Bootstrap Responsive Website Template -
      About Us : W3Layouts
    </title>
    <!-- google-fonts -->
    <link
      ...
      <div class="container py-md-5 py-4">
        <div class="row align-items-center justify-content-between">
          <div class="col-lg-6 about-2-secs-left">
            <h3 class="title-style mb-2">
              <span>Trabajamos</span> para su mejor éxito
            </h3>
            <p>Produzca y consuma de una manera responsable haciendo:</p>
            <ul class="list-about-2 mt-sm-4 mt-3">
              <li class="py-1">
                <i class="far fa-check-circle"></i>Más y mejor con menos
              </li>
              <li class="py-2">
                <i class="far fa-check-circle"></i>Mitiga la pobreza y a la
                transición hacia economías verdes y con bajas emisiones de
                carbono.
              </li>
              <li class="py-1">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 feature-body">
              ...
              <div class="feature-info">
                <a href="about.html">
                  <h3 class="feature-titel mb-3">Gran Apoyo</h3>
                </a>
                <p>
                  Sed ut perspiciatis unde omnis iste natus error sit accus
                  antium dolor emque lauda ntium.
                </p>
            ...
            <div class="col-lg-4 col-sm-6 feature-body mt-sm-0 mt-5">
              ...
              <div class="feature-info">
                <a href="about.html">
                  <h3 class="feature-titel mb-3">Tecnología Única</h3>
                </a>
                <p>
                  Sed ut perspiciatis unde omnis iste natus error sit accus
                  antium dolor emque lauda ntium.
            ...
            <div class="col-lg-4 col-sm-6 feature-body mt-lg-0 mt-5">
              ...
              <div class="feature-info">
                <a href="about.html">
                  <h3 class="feature-titel mb-3">Trabajo Inteligente</h3>
                </a>
                <p>
                  Sed ut perspiciatis unde omnis iste natus error sit accus
                  antium dolor emque lauda ntium.
        ...
        <div class="bg-pricemain row">
          <div class="col-lg-4 mb-lg-0 mb-5">
            <div class="title-main">
              <p class="title-small mb-2">Industry</p>
            </div>
            <h3 class="title-style">
              We Have <span>30+ Years</span> Of Experience
            </h3>
            <p class="pt-4">
              Aliquam ac est vel nisl condimentum interduauris et justo vel nibh
              rhoncusm vel eget enim. Curabitur mattis orci sed leo mattis, nec
              maximus nibh faucibus.
            </p>
            <a href="about.html" class="btn btn-style mt-lg-5 mt-4"
              >Read More</a
            >
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-md-0 mt-4 pl-lg-4">
            ...
            <p class="py-4 pl-3 d-inline about-right-text">
              ...
              Mauris et justo vel nibh rhoncus venenatis. Nullal dolor init
              condimentum interdum vel eget enim. Curabitur mattis orci sed le.
              Lorem dolor sit amet
            </p>
            <h5 class="abt-right mt-5">Industries Website</h5>
            <h4 class="abt-right-text pl-4 mt-4 pt-3">
              - The Best Industry Theme.
            </h4>
          </div>
        </div>
      </div>
    ...
    <section class="w3l-team-main" id="team">
      <div class="team py-5">
        <div class="container py-md-5 py-4">
          ...
          >
            <p class="mt-2 text-white">Our Team</p>
            <h3 class="title-style text-white">
              We Always Work With A Great <span>Team</span>
            </h3>
          </div>
