...
<html lang="es">
  <head>
    ...
    />
    <title>Produccion Y Consumo Respondable</title>
    <!-- google-fonts -->
    <link
  ...
  <body>
        ...
        <nav class="navbar navbar-expand-lg stroke">
          <h1>
            <a class="navbar-brand d-flex align-items-center" href="index.html">
              <i class="fas fa-tools mr-1" aria-hidden="true"></i>NECTAP TEG</a
            >
          </h1>
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-lg-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="grafica.php">Gráficas</a>
              </li>
              <li class="nav-item">
          ...
          <div class="row align-items-center">
            <div class="col-lg-5 col-md-6 pt-md-0 pt-4">
              <h3 class="mb-sm-4 mb-3 title">
                Construimos tu mejor
                <span class="d-block-res"
                  >F<span class="type-js"
                    ><span class="text-js">uturo!</span></span
                  ></span
                >
              </h3>
              <p>Garantizar modalidades de consumo y producción sostenibles.</p>
              <div class="mt-md-5 mt-4 mb-lg-0 mb-4">
                <a class="btn btn-style" href="services.html"
                  >Nuestros Servicios</a
                >
              </div>
            </div>
            <div
              class="col-md-6 banner-right mt-lg-4 mt-0 text-right offset-lg-1"
            >
              <img class="img-fluid" src="assets/images/img/3.jpg" alt=" " />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="about-single p-3 d-flex justify-content-between">
              ...
              <div class="about-content">
                <h5 class="mb-3">¿Cómo trabajamos?</h5>
                <p>
                  Sed ut perspiciatis unde omnis iste natus error sit accusa
                  ntium dolor emque laudan.
                </p>
    ...
    <section class="w3l-bottom-grids-6 service-w3l-bg py-5" id="services">
      <div class="container py-md-5 py-4">
        ...
        >
          <p class="mt-2 text-white">Nuestros Servicios</p>
          <h3 class="title-style text-white">
            Servicios de alto rendimiento para múltiples <span>Industrias</span>
          </h3>
        </div>
        <div class="row pt-md-4 justify-content-center">
          <div class="col-lg-4 col-md-6 grids-feature">
            <div class="area-box">
              ...
              <p>
                Amus a ligula quam tesque et libero ut justo, ultrices in. Ut eu
                leo non. Duis sed et dolor amet.
              </p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-sm-5 mt-4">
            <div class="area-box active">
              ...
              <h4>
                <a href="#feature" class="title-head">Mechanical Engineering</a>
              </h4>
              <p>
                Amus a ligula quam tesque et libero ut justo, ultrices in. Ut eu
                leo non. Duis sed dolor et amet.
              </p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-sm-5 mt-4">
            <div class="area-box">
              ...
              <h4>
                <a href="#feature" class="title-head">Electronic Materials</a>
              </h4>
              <p>
                Amus a ligula quam tesque et libero ut justo, ultrices in. Ut eu
                leo non. Duis sed dolor et amet.
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 content-sec-1">
            <h3 class="title-style mb-3">
              Los trabajadores expertos brindan los mejores servicios para
              construir
              <span>la fábrica de sus sueños</span>
            </h3>
            <p>
              Sed ut perspiciatis unde omnis iste natus error sit doloremque
              laudantium, totam rem aperiam, veritatis et quasi.
            </p>
            <a class="btn btn-style mt-lg-5 mt-4" href="services.html"
              >Conozcanos más</a
            >
          </div>
          <div class="col-lg-6 pl-lg-5 mt-lg-0 mt-5">
            <img
              src="assets/images/st1.jpg"
              alt="product"
            ...
            <div class="col-md-3 col-6">
              <div class="counter">
                <div
                  ...
                  data-speed="1500"
                ></div>
                <p class="count-text">Total Proyectos</p>
              </div>
            </div>
            <div class="col-md-3 col-6">
              <div class="counter">
    ...
    <section class="w3l-clients py-5 mb-5 mt-4" id="testimonials">
      <div class="container py-md-5 py-4">
        <div
          ...
          style="max-width: 600px"
        >
          <p class="mt-2">Testimonios</p>
          <h3 class="title-style">
            Happy With Customers & <span>Clients</span>
          </h3>
        </div>
            ...
            <div class="testimonial-content">
              <div class="testimonial">
                ...
                <p>
                  ...
                  primis in faucibus orci luctus et ultrices posuere,tesque
                  libero ut justo Semper.
                </p>
              </div>
    ...
    <div class="w3l-blog-content py-5">
      <div class="container py-md-5 py-4">
        <div
          ...
          style="max-width: 600px"
        >
          <p class="mt-2">Nuestro Blog</p>
          <h3 class="title-style">
            Obtenga más información de nuestras últimas publicaciones de
            <span>Blog</span>
          </h3>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="card-header p-0 position-relative">
              ...
              <div class="course-price-badge">Alimentos</div>
            </div>
            <div class="card-body course-details">
              <div class="course-meta mb-3">
                <div class="meta-item course-students">
                  <a href="#author"
                    ...
                    <span class="meta-value"></span>Michel</a
                  >
                </div>
              ...
              <a href="#blog" class="course-desc">
                Ayuda a los más necesitados
              </a>
              <p class="mt-3">
                Lorem ipsum dolor sit, amet consectetur elit. Earum mollitia cum
                ex ipsam autem!, earum. Fuga, soluta sequi!
              </p>
              <div class="blog-bottom-info">
                <a href="#blog" class="btn btn-style">Leer Más</a>
              </div>
            </div>
          </div>
          <div class="col-md-6 mt-md-0 mt-5">
            <div class="card-header p-0 position-relative">
              ...
              <div class="course-price-badge">Donar Alimentos</div>
            </div>
            <div class="card-body course-details">
              <div class="course-meta mb-3">
                <div class="meta-item course-students">
      ...
      <div class="footer-29-w3l py-5">
        <div class="container py-4">
          <div class="row footer-top-29">
            ...
            <div
              class="col-lg-2 col-md-6 col-sm-5 col-6 footer-list-29 footer-3 mt-lg-0 mt-5 pl-lg-4"
            >
            ...
            <div
              class="col-lg-4 col-md-6 col-sm-7 footer-list-29 footer-4 mt-lg-0 mt-5 pl-lg-5"
            >
              <h6 class="footer-title-29">Newsletter</h6>
              <form
                action="#"
                class="subscribe d-flex align-items-center"
                method="post"
              >
                <input
                  type="email"
              ...
              <h6 class="footer-title-29 pt-2 mt-4 mb-3">
                Give us a free call:
              </h6>
        ...
        <div class="container">
          <div class="row bottom-copies align-items-center">
            <p class="col-lg-8 copy-footer-29">
              @ 2021 Industries. All rights reserved. Design by
