...
$query = "SELECT * FROM proveedor order by Id_Prove desc limit 1";
...
<head>
  ...
  <title>Insertar_Provvedor</title>
...
<body class="contenedor_padre">
              ...
              <div class="card card-primary tarjeta">
                ...
                <h4 class="card-title text-center">REGISTRO DE PROVEEDORES</h4>
             ...
             <?php 
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form id="registro" name="registro" method="POST" action="guardar_pac_insert.php">
                  ...
                  <div class="d-flex flex-row justify-content-center"></div>
                    ...
                    <div class="p-2 col-lg-5">
                      ...
                      <input type="tel" class="form-control" name="Telefono" id="Telefono" placeholder="introduce el Telefono" required>
                    </div>
